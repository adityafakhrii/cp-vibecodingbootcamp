    ...
    levels: [
        {
            ...
            desc: "Punya website personal / company profile profesional yang sudah live dan bisa diakses publik secara instan.",
        ...
        },
        {
            ...
            desc: "Aplikasi kasir & dashboard bisnis yang beroperasi penuh, dilengkapi sistem database dan analytics nyata.",
        ...
        },
        {
            ...
            icon: Sparkles,
            title: "Full AI SaaS",
            desc: "Sistem aplikasi cerdas yang langsung terhubung dengan engine AI — persis seperti ChatGPT custom.",
...
export const mentorSection = {
    label: "MENTOR",
    title: "Belajar langsung dari mentor",
    ...
    organizations: [
        ...
        {
            name: "GDG Bandung",
            logo: "https://gdg-gtbit.netlify.app/Logos/gdgLogo.png",
        },
        {
            name: "Bangkit",
