    ...
    <section id="harga" className="py-20 md:py-28 relative">
      ...
      <div className="container relative">
        <SectionReveal className="max-w-2xl mx-auto text-center mb-14">
          <p className="text-sm font-medium text-gradient-brand mb-3">{pricingSection.label}</p>
        ...
        <SectionReveal className="max-w-2xl mx-auto">
          <div className="relative">
            ...
            <div className="relative glass-strong rounded-3xl p-8 md:p-10 shadow-glow">
              ...
              <h3 className="text-2xl font-bold mb-2">{pricingSection.planTitle}</h3>
              <p className="text-muted-foreground mb-7">{pricingSection.planSubtitle}</p>
              ...
              <div className="flex items-center gap-3 mb-7">
                <span className="text-muted-foreground line-through">{pricingSection.originalPrice}</span>
              ...
              <div className="hairline rounded-2xl p-4 mb-7 bg-background/40">
                <p className="text-sm">
                  ⚠️ <span className="font-semibold">{pricingSection.urgencyNote}</span> {pricingSection.urgencyDetail}
                </p>
              </div>
              ...
              <GradientButton asChildHref={pricingSection.ctaHref} size="lg" className="w-full">
